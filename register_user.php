                ...
                <div class="login-card">
                  ...
                  <form action="proses_daftar_user.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                          <input type="password" class="form-control" name="password-confirmation" id="password-confirmation" placeholder="Masukkan ulang sandi ..." required>
                        </div>
                    </div>
                    <div class="form-check mt-4">
                        <input class="form-check-input" type="checkbox" id="accept-terms" name="accept-terms" required>
                        <label class="form-check-label" for="accept-terms">
                            Saya menerima S&K yang berlaku
                        </label>
                    </div>
                    <div class="d-grid mt-4">
                      <button type="submit" id="daftar" name="btnSubmit" class="btn btn-primary">Daftar</button>
                    </div>
                  </form>
                  <div class="text-link text-center mt-3">
                    Sudah memiliki akun? <a href="login_user.php" class="text-decoration-none">Masuk disini</a>
                  </div>
                </div>
              </div>
