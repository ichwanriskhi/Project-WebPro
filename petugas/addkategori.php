        ...
        <div class="mt-4">
          <div class="card py-3 px-3">
            <h6 class="mb-3">Penambahan Kategori Barang Lelang</h6>
              <form action="addk.php" method="POST">                                
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label for="id_kategori" class="fw-bold text-dark">Kode Kategori</label>
                    <input type="text" name="id_kategori" class="form-control ps-3 bg-gray-100" placeholder="Masukkan kode kategori..." required>
                  </div>
                  <div class="col-md-6">
                    <label for="nama_kategori" class="fw-bold text-dark">Nama Kategori</label>
                    <input type="text" name="nama_kategori" class="form-control ps-3 bg-gray-100" placeholder="Masukkan nama kategori..." required>
                  </div>
